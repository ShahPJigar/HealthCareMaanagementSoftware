...
public class NewTreatments {

	JFrame frame;
	private JTextField TreatmentText;
	...
	private void initialize() {
		...
		frame.getContentPane().setLayout(
				new FormLayout(new ColumnSpec[] {
						...
						FormFactory.DEFAULT_ROWSPEC, }));
										...
										lblConditions = new JLabel("Treatments");
										frame.getContentPane().add(lblConditions, "6, 4");
										
										TreatmentText = new JTextField();
										frame.getContentPane().add(TreatmentText, "6, 6, fill, default");
										TreatmentText.setColumns(10);
		...
		JButton btnSearch_1 = new JButton("Add Treatment");
		...
		btnSearch_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//String gender = null;// '\u0000';
				//int age = -1;
				String treat = TreatmentText.getText();
				String sdate = StartDate.getText();
				String edate = EndDate.getText();
				//String email = EmailText.getText();
				//int index = comboBox.getSelectedIndex();
				System.out.println(treat);
				if ((treat.equals("")) || (sdate.equals(""))) {
					lblWarning
							.setText("Add Condition and Start Date.");
					lblWarning.setVisible(true);
				} else {
					//age = Integer.parseInt(edate);
					Treatment t = new Treatment("", "", treat, sdate,edate);
					int nid = c.newTreatmentData(t);
					String restext = "Added New Treatment- " + nid;
